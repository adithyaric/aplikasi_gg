                    ...
                    <div class="card-body">
                        <form action="{{ route('import.sekolah') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="{{ asset('templates/template-sekolah.csv') }}" class="btn btn-secondary ms-2">
                                    <i class="bi bi-file-earmark-spreadsheet "></i> Template
                                </a>
                                <a href="{{ route('export.sekolah') }}" class="btn btn-success ms-2">
...
@push('js')
                    ...
                    setTimeout(function() {
                        if (response.lat && response.long) {
                            ...
                            markerSekolah = L.marker([response.lat, response.long], {
                                ...
                                .openPopup();
                            mapSekolah.setView([response.lat, response.long], 5);
                        }
                    }, 400);
                }
            });
    ...
    <script>
        ...
        function resetForm() {
            ...
            if (mapSekolah) {
                // Center of Indonesia
                mapSekolah.setView([-2.5489, 118.0149], 4);
            }
        }
