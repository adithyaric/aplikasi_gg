                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title fw-bold">Rekap Penerimaan Dana</h4>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row align-items-end mb-4 justify-content-between">
                                ...
                                <div class="col-auto text-end">
                                    <button class="btn btn-success" data-bs-toggle="modal"
                                        ...
                                        <i class="bi bi-printer"></i> Cetak Rekap Penerimaan
                                    </button>
                                </div>
                            </div>
            ...
            <div class="modal-content p-4">
                <div class="modal-header border-bottom-0">
                    <h5 class="modal-title fw-bold">
                        <i class="bi bi-printer-fill"></i> Cetak Rekap Penerimaan Dana
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <div id="printArea">
                        <div class="text-center mb-4">
                            <h5><strong>REKAP PENERIMAAN DANA</strong></h5>
                            <p class="mb-0">
                                Periode:
                ...
                <div class="modal-footer border-top-0">
                    ...
                    <a href="{{ route('export.rekap-penerimaan-dana') }}" class="btn btn-success ms-2">
        ...
        $(document).ready(function() {
            ...
            function getTabelUtamaData() {
                ...
                $("#datatable tbody tr").each(function() {
                    const row = {
                        ...
                        periode: $(this).find("td:eq(3)").text().trim(),
                        kredit: parseFloat(
                            $(this)
                            .find("td:eq(4)")
                            .text()
            ...
            function renderCetakTable(data) {
              ...
              <tr>
                ...
                <td>${item.uraian}</td>
                <td>${item.periode}</td>
                <td>${item.kredit.toLocaleString("id-ID")}</td>
              </tr>
            `);
                });
