    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('penggunaan.*') ? 'active' : '' }}"
                        ...
                        <span class="item-name">Penggunaan Barang</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('report.rekap-porsi') ? 'active' : '' }}" href="{{ route('report.rekap-porsi') }}">
                        ...
                        <span class="item-name">Rekap Porsi</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('report.rekap-penerimaan-dana') ? 'active' : '' }}" href="{{ route('report.rekap-penerimaan-dana') }}">
                        ...
                        <span class="item-name">Penerimaan Dana</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('report.lpdb') ? 'active' : '' }}" href="{{ route('report.lpdb') }}">
                        ...
                        <span class="item-name">LPDB</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('report.lbbp') ? 'active' : '' }}" href="{{ route('report.lbbp') }}">
                        ...
                        <span class="item-name">LBBP</span>
                    </a>
                </li>
                <li class="nav-item">
