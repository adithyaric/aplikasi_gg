                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control @error('no_bukti') is-invalid @enderror"
                                        id="no_bukti" name="no_bukti" value="{{ old('no_bukti', $rekeningBKU->no_bukti) }}"
                                ...
                                <div class="form-group col-4">
                                    ...
                                    @if ($rekeningBKU->link_bukti)
                                        <small class="text-success">
                                            File saat ini:
                                            <a href="{{ Storage::url($rekeningBKU->link_bukti) }}" target="_blank">
                                                Lihat Bukti
                                            </a>
                                        </small>
                                    @endif
                            ...
                            <div class="row mt-3">
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control @error('jenis_bahan') is-invalid @enderror"
                                        ...
                                        value="{{ old('jenis_bahan', $rekeningBKU->jenis_bahan) }}"
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control @error('nama_bahan') is-invalid @enderror"
                                        ...
                                        value="{{ old('nama_bahan', $rekeningBKU->nama_bahan) }}"
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="number" class="form-control @error('kuantitas') is-invalid @enderror"
                                        ...
                                        value="{{ old('kuantitas', $rekeningBKU->kuantitas ?? 1) }}" min="1">
                                    @error('kuantitas')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control @error('supplier') is-invalid @enderror"
                                        ...
                                        value="{{ old('supplier', $rekeningBKU->supplier) }}"
                            ...
                            <div class="row mt-3">
                                <div class="form-group col-4">
                                    ...
                                    <input type="number" class="form-control @error('debit') is-invalid @enderror"
                                        id="debit" name="debit" value="{{ old('debit', $rekeningBKU->debit) }}"
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="number" class="form-control @error('kredit') is-invalid @enderror"
                                        id="kredit" name="kredit" value="{{ old('kredit', $rekeningBKU->kredit) }}"
                                        step="0.01" min="0" required>
                                    @error('kredit')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control bg-light" readonly
                                        value="Rp {{ number_format($rekeningBKU->saldo, 0, ',', '.') }}">
                                    <small class="text-muted">Saldo akan dihitung ulang setelah perubahan</small>
                                </div>
                            </div>
