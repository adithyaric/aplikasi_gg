                    ...
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="#" class="btn btn-link btn-soft-light" data-bs-toggle="modal"
                                data-bs-target="#modalKaryawan" onclick="resetForm()">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title fw-bold">Relawan</h4>
                    </div>
                    <div class="card-body">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content"
                ...
                <div class="modal-header bg-primary">
                    <h5 class="modal-title text-white" id="modalKaryawanLabel">Tambah Relawan</h5>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="lahir_tempat"
                                                name="lahir_tempat" placeholder="Masukkan tempat lahir">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label class="form-label">Tanggal Lahir</label>
                                            <input type="date" class="form-control" id="lahir_tanggal"
                                                name="lahir_tanggal">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control" id="kategori_karyawan_id"
...
@push('js')
    <script>
        ...
        function resetForm() {
            ...
            $('#modalKaryawanLabel').text('Tambah Relawan');
            $('.form-control').removeClass('is-invalid');
            $('.invalid-feedback').text('');
            $('#kategori_ids').val(null).trigger('change');
        }
        ...
        $('#formKaryawan').on('submit', function(e) {
            ...
            let url = id ? "{{ route('karyawan.index') }}/" + id : "{{ route('karyawan.store') }}";
        ...
        function editKaryawan(id) {
            $.ajax({
                url: "{{ route('karyawan.index') }}/" + id,
                method: 'GET',
                success: function(response) {
                    $('#karyawan_id').val(response.id);
                    $('#nama').val(response.nama);
                    $('#no_hp').val(response.no_hp);
                    $('#lahir_tempat').val(response.lahir_tempat);
                    $('#alamat').val(response.alamat);

                    // Format the date for input type="date"
                    if (response.lahir_tanggal) {
                        let dateObj = new Date(response.lahir_tanggal);
                        let year = dateObj.getFullYear();
                        let month = String(dateObj.getMonth() + 1).padStart(2, '0');
                        let day = String(dateObj.getDate()).padStart(2, '0');
                        $('#lahir_tanggal').val(`${year}-${month}-${day}`);
                    } else {
                        $('#lahir_tanggal').val('');
                    }
                    ...
                    $('#form_method').val('PUT');
                    $('#modalKaryawanLabel').text('Edit Relawan');

                    // Set selected kategori
                    $('#kategori_karyawan_id').val(response.kategori_karyawan_id);
