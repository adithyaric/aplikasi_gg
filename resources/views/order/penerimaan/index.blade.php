                                    ...
                                    @foreach ($orders as $order)
                                        <tr data-status="{{ $order->status_penerimaan }}">
                                            ...
                                            <td>
                                                <h5>
                                                    <span
                                                        class="badge bg-{{ $order->status_penerimaan == 'draft' ? 'gray' : 'success' }}">
                                                        {{ ucfirst($order->status_penerimaan) }}
                                                    </span>
                                                </h5>
                                            </td>
                                            <td>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="penerimaan_catatan" disabled>Tidak ada catatan...</textarea>
                                </div>
                            </div>
                            <hr class="hr-horizontal" />
