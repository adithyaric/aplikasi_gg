                    ...
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="#" class="btn btn-link btn-soft-light" data-bs-toggle="modal"
                                data-bs-target="#modalBahanBaku" onclick="resetForm()">
...
@section('container')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title fw-bold">Bahan Baku</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('import.bahan-baku') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="{{ asset('templates/template-bahan_baku.csv') }}" class="btn btn-secondary ms-2">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="tableBahanBaku">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger"
                                                    onclick="deleteBahanBaku({{ $bahanbaku->id }})">
                                                    <span class="btn-inner">
                                                        <svg class="icon-20" width="20" viewBox="0 0 24 24"
                                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalBahanBaku" tabindex="-1" aria-labelledby="modalBahanBakuLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content"
                style="border-radius:15px; border:1px solid #ddd; box-shadow:0 8px 20px rgba(0,0,0,0.2);">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title text-white" id="modalBahanBakuLabel">Tambah Bahan Baku</h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="formBahanBaku">
                                @csrf
                                <input type="hidden" id="bahanbaku_id" name="bahanbaku_id">
...
@push('js')
    <script>
        ...
        $('#formBahanBaku').on('submit', function(e) {
            ...
            let id = $('#bahanbaku_id').val();
            let url = id ? "{{ route('bahanbaku.index') }}/" + id : "{{ route('bahanbaku.store') }}";
        ...
        function editBahanBaku(id) {
            $.ajax({
                url: "{{ route('bahanbaku.index') }}/" + id + "/edit",
                method: 'GET',
                success: function(response) {
                    $('#bahanbaku_id').val(response.id);
