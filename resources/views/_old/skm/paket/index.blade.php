...
<div class="iq-navbar-header" style="height: 215px;">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content" style="border-radius:15px; border:1px solid #ddd; box-shadow:0 8px 20px rgba(0,0,0,0.2);">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title text-white" id="modalTambahLabel">Tambah Paket SKM</h5>
                ...
                <div class="modal-body">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('skm.paket.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="nama" class="form-control" placeholder="Masukkan nama paket" required>
                                </div>
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEditLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content" style="border-radius:15px; border:1px solid #ddd; box-shadow:0 8px 20px rgba(0,0,0,0.2);">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title text-white" id="modalEditLabel">Edit Paket SKM</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body">
                    <div class="card">
                        <div class="card-body">
                            <form id="formEdit" method="POST" action="{{ route('skm.paket.update', ['paket' => '__id__']) }}">
                                @csrf
                                @method('PUT')
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Data Paket SKM</h4>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table id="datatable" class="table table-striped" data-toggle="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->status ?? '-' }}</td>
                                    <td>
                                        <a title="Lihat Opsi Jawaban" href="{{ route('skm.paket.show', $item->id) }}" class="btn btn-icon btn-info">
...
<script>
    ...
    modalEdit.addEventListener('show.bs.modal', function(event) {
        ...
        document.getElementById('edit_kategori_id').value = btn.getAttribute('data-kategori_id');
        document.getElementById('edit_tanggal_mulai').value = btn.getAttribute('data-tanggal_mulai');
        document.getElementById('edit_tanggal_selesai').value = btn.getAttribute('data-tanggal_selesai');

        const statusSelect = document.getElementById('edit_status');
        statusSelect.value = btn.getAttribute('data-status');

        const form = document.getElementById('formEdit');
        form.action = "{{ route('skm.paket.update', ['paket' => '__id__']) }}".replace('__id__', btn.getAttribute('data-id'));
    });
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        modalDelete.addEventListener('show.bs.modal', function(event) {
            ...
            formDelete.action = "{{ route('skm.paket.destroy', ['paket' => '__id__']) }}".replace('__id__', btn.getAttribute('data-id'));
        });
    });
</script>
@endpush
