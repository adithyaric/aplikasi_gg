{{-- resources/views/gizi/index.blade.php --}}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('gizi.create') }}" class="btn btn-link btn-soft-light">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title fw-bold">Database Gizi</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('import.gizi') }}" method="POST" enctype="multipart/form-data"
                            class="row g-3">
                            @csrf
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                ...
                                {{-- <a href="{{ asset('templates/gizi_template.xlsx') }}" class="btn btn-success ms-2"> --}}
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="tableGizi">
                                <thead class="align-middle">
                                    <tr>
                                        <th rowspan="2">No</th>
                                        <th rowspan="2">Nomor Pangan</th>
                                        <th rowspan="2">Rincian Bahan Makanan</th>
                                        <th rowspan="2">BDD (%)</th>
                                        <th>AIR</th>
                                        <th>ENERGI</th>
                                        <th>PROTEIN</th>
                                ...
                                <tbody>
                                    @foreach ($gizis as $index => $gizi)
                                        <tr>
                                            ...
                                            <td>{{ $gizi->retinol }}</td>
                                            <td>{{ $gizi->b_kar }}</td>
                                            <td>{{ $gizi->kar_total }}</td>
                                            <td>{{ $gizi->thiamin }}</td>
                                            <td>{{ $gizi->riboflavin }}</td>
                                            <td>{{ $gizi->niasin }}</td>
                                            <td>{{ $gizi->vitamin_c }}</td>
                                            <td>
                                                <a href="{{ route('gizi.edit', $gizi->id) }}"
