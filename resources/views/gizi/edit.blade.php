{{-- resources/views/gizi/edit.blade.php --}}
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title fw-bold">Edit Data Gizi</h4>
                    </div>
                    <div class="card-body">
                                            ...
                                            <div class="row g-1">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="number" step="0.01" name="bdd"
                                                        ...
                                                        placeholder="100" value="{{ old('bdd', $gizi->bdd) }}" required>
