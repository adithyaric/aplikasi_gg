...
<div class="iq-navbar-header" style="height: 215px;">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content" style="border-radius:15px; border:1px solid #ddd; box-shadow:0 8px 20px rgba(0,0,0,0.2);">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title text-white" id="modalTambahLabel">Tambah Kategori SKM</h5>
                ...
                <div class="modal-body">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('skm.kategori.store') }}" method="POST">
                                @csrf
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEditLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content" style="border-radius:15px; border:1px solid #ddd; box-shadow:0 8px 20px rgba(0,0,0,0.2);">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title text-white" id="modalEditLabel">Edit Kategori SKM</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body">
                    <div class="card">
                        <div class="card-body">
                            <form id="formEdit" method="POST" action="{{ route('skm.kategori.update', ['kategori' => '__id__']) }}">
                                @csrf
                                @method('PUT')
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Data Kategori SKM</h4>
                    </div>
                </div>
                <div class="card-body">
...
<script>
    ...
    modalEdit.addEventListener('show.bs.modal', function(event) {
        ...
        form.action = "{{ route('skm.kategori.update', ['kategori' => '__id__']) }}".replace('__id__', id);
    });
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        modalDelete.addEventListener('show.bs.modal', function(event) {
            ...
            formDelete.action = `/skm/kategori/${id}`;
        });
    });
</script>
@endpush
